...
public class JwtFilter extends GenericFilterBean {
    ...
    public void doFilter(final ServletRequest req,
        ...
        log.info("##########Entered into JwtFilter.doFilter()##########");
       ...
       final String token =authHeader.substring(7); // The part after "Bearer "
        ...
        try {
                final Claims claims = Jwts.parser().setSigningKey("123456".getBytes("UTF-8")).parseClaimsJws(token).getBody();
        ...
        log.info("##########Exit from JwtFilter.doFilter()##########");
    }
    }
}
